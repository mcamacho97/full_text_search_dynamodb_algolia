resource "aws_s3_bucket" "this" {
  ...
  #   provider = aws.infra
  bucket = "${var.generic.project_name}-web-hosting"
}
...
resource "aws_s3_bucket" "this2" {
  ...
  #checkov:skip=CKV2_AWS_61
  #   provider = aws.infra
  bucket = "${var.generic.project_name}-web-hosting1"
}
...
resource "aws_s3_bucket" "this3" {
  ...
  #checkov:skip=CKV2_AWS_61
  #   provider = aws.infra
  bucket = "${var.generic.project_name}-web-hosting2"
}
...
resource "aws_cloudfront_origin_access_control" "this" {
  #   provider = aws.infra
  name                              = "${var.generic.policy_prefix}${local.project_name.pascal}-OAC2"
  description                       = "SMS Campaigns Frontend OAC policy"
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  comment = "SMS Campaigns Frontend hosting distribution"
